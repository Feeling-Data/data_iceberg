...
let recentPositions = [];
const SETTLE_DETECTION_WINDOW = 20; // Number of recent positions to track (increased for longer settle time)
const SETTLE_THRESHOLD = 3; // Maximum distance between positions to consider "settled"
const MOVEMENT_THRESHOLD = 2; // Minimum movement to consider as "moved"
